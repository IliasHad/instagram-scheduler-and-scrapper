            ...
            <div class="flex items-center justify-between h-16">
              <div class="flex items-center">
                <div class="flex-shrink-0">
                  <img class="h-8 w-8" src={logo} alt="Workflow logo" />
                </div>
...
<div className="my-10">
  <label for="price" class="text-sm leading-5 font-medium text-gray-700">Instagram Post</label>
  <div class="mt-1  ml-4 relative rounded-md shadow-sm inline-block">

    <input id="price" class="form-input  py-2 pl-7 pr-12 sm:text-sm sm:leading-5" type="text" />
  
  </div>
  <span class="sm:ml-3 shadow-sm rounded-md inline-block">
